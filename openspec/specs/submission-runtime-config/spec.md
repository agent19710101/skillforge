# submission-runtime-config Specification

## Purpose
Define the runtime configuration and repository-boundary rules that enable live draft submission without requiring temp draft workspaces to be Git repositories.
## Requirements
