# repository-ingestion Specification

## Purpose
Define how Skillforge discovers, parses, validates, and normalizes canonical skills from the single Git-backed repository.
## Requirements
