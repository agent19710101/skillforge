# catalog-read-api Specification

## Purpose
Define the read-only HTTP API for listing, searching, and retrieving skills from the derived catalog built from the canonical skills repository.
## Requirements
