...
- [x] 4.1 Document the required submission environment variables and working-copy expectations.
- [x] 4.2 Update Compose/dev documentation so operators can enable live submission intentionally.
- [x] 4.3 Add a local verification flow for creating a draft and opening a PR against Forgejo.
...
- [x] 5.3 Archive the change when the live submission path is coherent end to end.
