...
- [ ] 2.1 Implement an in-process derived index for list/search/get operations.
- [ ] 2.2 Add `GET /api/v1/skills` with pagination and basic filtering.
- [ ] 2.3 Add `GET /api/v1/skills/:name` for skill detail retrieval.
- [ ] 2.4 Add `GET /api/v1/search` for metadata-oriented search.
- [ ] 2.5 Add `GET /api/v1/index/status` for scan/index health visibility.
